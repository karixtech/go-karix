...
func (m *CreateWebhookBadRequestBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateWebhookBadRequestBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *CreateWebhookBadRequestBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateWebhookBadRequestBodyError) UnmarshalBinary(b []byte) error {

...
func (m *PatchSubaccountInternalServerErrorBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PatchSubaccountInternalServerErrorBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *PatchSubaccountInternalServerErrorBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PatchSubaccountInternalServerErrorBodyError) UnmarshalBinary(b []byte) error {

...
func (m *SendMessageInternalServerErrorBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SendMessageInternalServerErrorBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *SendMessageInternalServerErrorBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SendMessageInternalServerErrorBodyError) UnmarshalBinary(b []byte) error {

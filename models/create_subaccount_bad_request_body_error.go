...
func (m *CreateSubaccountBadRequestBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateSubaccountBadRequestBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *CreateSubaccountBadRequestBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateSubaccountBadRequestBodyError) UnmarshalBinary(b []byte) error {

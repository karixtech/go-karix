...
func (m *GetWebhookInternalServerErrorBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetWebhookInternalServerErrorBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *GetWebhookInternalServerErrorBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetWebhookInternalServerErrorBodyError) UnmarshalBinary(b []byte) error {

...
func (m *GetNumberInternalServerErrorBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNumberInternalServerErrorBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *GetNumberInternalServerErrorBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetNumberInternalServerErrorBodyError) UnmarshalBinary(b []byte) error {

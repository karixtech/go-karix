...
func (m *GetSubaccountByIDInternalServerErrorBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSubaccountByIDInternalServerErrorBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *GetSubaccountByIDInternalServerErrorBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSubaccountByIDInternalServerErrorBodyError) UnmarshalBinary(b []byte) error {

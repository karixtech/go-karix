...
func (m *SendMessageBadRequestBodyError) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SendMessageBadRequestBodyError) validateMessage(formats strfmt.Registry) error {
...
func (m *SendMessageBadRequestBodyError) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SendMessageBadRequestBodyError) UnmarshalBinary(b []byte) error {
